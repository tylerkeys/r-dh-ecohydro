...
vahydro_fe_data_icthy <- function (Watershed_Hydrocode,x_metric_code,y_metric_code,bundle,ws_ftype_code,sampres, data) {
  ...
  uri <- paste(
    site,"elfgen_data_export_sample_event",x_metric_code,"aqbio_nt_total",
